...
<%
    ...
    // Create only one instance of PostDao
...
<html>
<head>
    <title><%= post != null ? post.getpTitle() : "Post Not Found" %></title>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="Profile.jsp"><span class="fa fa-bell-o"></span> LearnCode with Saad</a>
      </li>
        ...
        <div class="col-md-8 offset-md-2 ">
             <div class="card">
                      ...
                      <div class="row my-3 row-user">
                            <div class="col-md-8">
                                  <%
                                      ...
                                      String userName = ud.getUserByUserId(post.getUserId()).getName();
                                  %>
                 ...
                 <div class="card-footer primary-background text-center">
                   ...
                   %>
                      <a href="#!" onclick="doLike(<%= post.getPid()%>, <%= post.getUserId() %>)"  class="btn btn-outline-light btn-sm"><i class="fa fa-thumbs-o-up "><span class="like-counter"><%=likeDao.countLikeOnPost(post.getPid())%></span></i></a>
